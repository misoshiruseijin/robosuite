...
from robosuite.models.objects import GridObject
...
class Reaching(SingleArmEnv):
    ...
    def __init__(
        ...
        target_half_size=(0.05, 0.125), # target area x and y dimensions
        # target_position=(0.0, 0.0), # target area position on table
        grid_thickness=0.001,
        random_init=True,
        lock_z=True, # lock motion in z axis
    ):
        ...
        # whether to lock motion in z axis
        self.lock_z = lock_z
    ...
    def reward(self, action=None): ### TODO ###
        ...
        #     reward = -0.1 * (self._eef_xpos[0] ** 2 + self._eef_xpos[1] ** 2) ** 0.5
    ...
    def _load_model(self):
        ...
        self.grid = GridObject(
            name="grid",
            body_half_size=(self.table_full_size[0]/4, self.table_full_size[1]/4, self.grid_thickness),
    ...
    def visualize(self, vis_settings):
        ...
        if vis_settings["grippers"]:
            self._visualize_gripper_to_target(gripper=self.robots[0].gripper, target=self.grid)
