...
class FloatingStageObject(CompositeObject):
    """
    ...
    def _get_geom_attrs(self):
        ...
        #     dic=obj_args,
        #     geom_types="box",
        #     geom_locations=(self.body_half_size[0] - self.thickness / 2, 0, self.body_half_size[2]),
        #     geom_quats=(1, 0, 0, 0),
        #     geom_sizes=np.array([self.thickness, self.body_half_size[1], self.body_half_size[2] - self.thickness]),
        #     geom_names=name,
        #     geom_rgbas=self.rgba,
        #     geom_frictions=None,
        #     density=self.density,
