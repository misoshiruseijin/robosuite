...
class CylinderPostObject(CompositeObject):
    """
    ...
    def __init__(
        self,
        name,
        body_half_size=(0.01, 0.1),
        density=1000,
        rgba=None,
        frictions=(0.005, 0.005, 0.0001),
    ):
        # Set name
        self._name = name
    ...
    def bottom_offset(self):
        return np.array([0, 0, -1 * self.body_half_size[1]])

    @property
    def top_offset(self):
        return np.array([0, 0, self.body_half_size[1]])
